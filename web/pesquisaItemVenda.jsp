...
<html>
    ...
    <body>
        ...
        <h1 class="display-3">Pesquisar Itens Vendas</h1>
            ...
            <table border =1 class="table">
                ...
                <tbody>
                    <c:forEach items="${itensvendas}" var="itemvenda">
                        <tr>
                            <th scope="row"><c:out value="${itemvenda.idItemVenda}" /></td>
                            ...
                            <td><a href="ManterItemVendaController?acao=prepararOperacao&operacao=Excluir&idItemVenda=<c:out value="${itemvenda.idItemVenda}"/>">Excluir</a></td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
