    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="Relatorio1Distribuidor?acao=emitir">Emitir relatório com agrupamento</a>
                </li>             
            </div>
        </nav>
        <h1 class="display-3">Pesquisar Distribuidores</h1>
            ...
            <table border =1 class="table">
                ...
                <tbody>
                    <c:forEach items="${distribuidores}" var="distribuidor">
                        <tr>
                            <th scope="row"><c:out value="${distribuidor.idDistribuidor}" /></th>
                            ...
                            <td><a href="ManterDistribuidorController?acao=prepararOperacao&operacao=Excluir&idDistribuidor=<c:out value="${distribuidor.idDistribuidor}"/>">Excluir</a></td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
