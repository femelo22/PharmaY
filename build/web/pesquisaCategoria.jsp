    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="Relatorio1CategoriaController?acao=emitir">Emitir relatório com agrupamento</a>
                </li>            
            </div>
        </nav>
        <h5 class="display-3">Pesquisar Categoria</h5>
        <div class="table-responsive table-striped mx-auto" style="width: 500px; height: 1000px; margin-top: 100px">
            <table border="1" class="table">
                ...
                <tbody>
                    <c:forEach items="${categorias}" var="categoria">
                        <tr>
                            <th scope="row"><c:out value="${categoria.idCategoria}"/> </th>
